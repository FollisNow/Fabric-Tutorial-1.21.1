...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerCrop(ModBlocks.GOLDEN_CARAT_CROP, GoldenCaratCropBlock.AGE, 0, 1, 2, 3);
...
//        itemModelGenerator.register(ModItems.MOTH_ITEM, Models.GENERATED);
        ...
        itemModelGenerator.register(ModItems.SCORPION_SPAWN_EGG,
                new Model(Optional.of(Identifier.of("item/template_spawn_egg")), Optional.empty()));
      ...
      itemModelGenerator.register(ModItems.MOTH_SPAWN_EGG,
        ...
        itemModelGenerator.register(ModItems.LARVAE_SPAWN_EGG,
                new Model(Optional.of(Identifier.of("item/template_spawn_egg")), Optional.empty()));
