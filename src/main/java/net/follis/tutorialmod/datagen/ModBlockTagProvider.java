...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE)
                ...
                .add(ModBlocks.COBBLED_GOLD_STAIRS)
                .add(ModBlocks.COBBLED_GOLD_SLAB)
                .add(ModBlocks.COBBLED_GOLD_WALL)
                ...
                .add(ModBlocks.GOLD_LARGE_BRICK_STAIRS)
                .add(ModBlocks.GOLD_LARGE_BRICK_SLAB)
                .add(ModBlocks.GOLD_LARGE_BRICK_WALL)
