...
public class MantisEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new HarvestBlockGoal(this, Blocks.WHEAT, 10, false)); // Specify the block to harvest
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        ...
        if (entity instanceof MantisEntity partner && (this.getVariant() == partner.getVariant())) {
