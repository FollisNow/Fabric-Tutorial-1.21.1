...
public class GoldenSilverfishModel<T extends Entity> extends SinglePartEntityModel<T> {
    public static final EntityModelLayer GOLDEN_SILVERFISH = new EntityModelLayer(Identifier.of(TutorialMod.MOD_ID, "golden_silverfish"), "main");

    public GoldenSilverfishModel(ModelPart root) {
        this.root = root;
