...
public class BeetleModel<T extends BeetleEntity> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = beetle.addChild("head", ModelPartBuilder.create().uv(15, 0).cuboid(-1.0F, -2.0F, -2.0F, 2.0F, 2.0F, 3.0F, new Dilation(-0.001F)), ModelTransform.pivot(0.0F, -2.0F, -3.0F));

        ModelPartData mandible_r1 = head.addChild("mandible_r1", ModelPartBuilder.create().uv(17, 8).cuboid(-2.5F, 0.0F, 0.0F, 5.0F, 0.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, -2.0F, 2.8798F, 0.0F, 0.0F));
        ...
        ModelPartData central_wing_r1 = central_wing.addChild("central_wing_r1", ModelPartBuilder.create().uv(5, 8).cuboid(-2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 5.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.1745F, 0.0F, 0.0F));
        ...
        ModelPartData cube_r1 = right_legs.addChild("cube_r1", ModelPartBuilder.create().uv(0, -1).cuboid(-2.0602F, -0.7288F, -2.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.001F))
                .uv(0, -1).cuboid(-2.0602F, -0.7288F, 1.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.001F))
                .uv(0, -1).cuboid(-2.0602F, -0.7288F, -0.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1309F));
        ...
        ModelPartData cube_r2 = left_legs.addChild("cube_r2", ModelPartBuilder.create().uv(2, -1).cuboid(2.0602F, -0.7288F, 1.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.001F))
                .uv(2, -1).cuboid(2.0602F, -0.7288F, -0.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.001F))
                .uv(2, -1).cuboid(2.0602F, -0.7288F, -2.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

        ModelPartData mainBody = beetle.addChild("mainBody", ModelPartBuilder.create().uv(12, 13).cuboid(-1.0F, -0.6667F, -0.8333F, 2.0F, 1.0F, 4.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-2.0F, 0.3333F, -2.8333F, 4.0F, 1.0F, 7.0F, new Dilation(0.0F))
                .uv(12, 18).cuboid(-2.0F, -1.6667F, -2.8333F, 4.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -3.3333F, -0.1667F));
