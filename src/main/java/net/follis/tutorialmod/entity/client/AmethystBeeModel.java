...
public class AmethystBeeModel<T extends AmethystBeeEntity> extends SinglePartEntityModel<T> {
    public static final EntityModelLayer AMETHYST_BEE = new EntityModelLayer(Identifier.of(TutorialMod.MOD_ID, "amethyst_bee"), "main");
    ...
    public AmethystBeeModel(ModelPart root) {
        super();
