...
public class LocustModel<T extends LocustEntity> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData antennae = body.addChild("antennae", ModelPartBuilder.create().uv(28, 29).cuboid(1.0F, -1.0F, 0.0F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(12, 30).cuboid(-1.0F, -1.0F, 0.0F, 0.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(24, 29).cuboid(1.0F, -3.0F, 1.0F, 0.0F, 2.0F, 1.0F, new Dilation(0.0F))
                .uv(26, 29).cuboid(-1.0F, -3.0F, 1.0F, 0.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -1.5F, 5.45F));
        ...
        ModelPartData backLegs = body.addChild("backLegs", ModelPartBuilder.create().uv(18, 23).cuboid(1.0F, -0.4812F, -4.5108F, 1.0F, 1.0F, 5.0F, new Dilation(0.0F))
                ...
                .uv(12, 26).cuboid(1.0F, 0.5188F, -4.5108F, 1.0F, 4.0F, 0.0F, new Dilation(0.0F))
                .uv(14, 26).cuboid(-2.0F, 0.5188F, -4.5108F, 1.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.7F, -0.35F, -0.5149F, 0.0F, 0.0F));
        ...
        ModelPartData cube_r1 = right_frontLegs.addChild("cube_r1", ModelPartBuilder.create().uv(16, 26).cuboid(0.0F, -1.5F, -0.5F, 0.0F, 3.0F, 1.0F, new Dilation(0.0F))
                .uv(20, 29).cuboid(0.0F, -1.5F, -2.5F, 0.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 1.0F, 0.0F, 0.0F, -1.1432F));
        ...
        ModelPartData cube_r2 = left_frontLegs.addChild("cube_r2", ModelPartBuilder.create().uv(22, 29).cuboid(0.0F, -1.5F, -0.5F, 0.0F, 3.0F, 1.0F, new Dilation(0.0F))
                .uv(18, 29).cuboid(0.0F, -1.5F, -2.5F, 0.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 1.1432F));
        ...
        ModelPartData bone = left_wing.addChild("bone", ModelPartBuilder.create().uv(18, 0).cuboid(-0.144F, -0.0718F, -6.8826F, 0.0F, 1.0F, 7.0F, new Dilation(0.0F))
                .uv(0, 10).cuboid(-0.144F, -0.0718F, -7.8826F, 1.0F, 0.0F, 8.0F, new Dilation(0.0F))
        ...
        ModelPartData bone2 = right_wing.addChild("bone2", ModelPartBuilder.create().uv(18, 8).cuboid(0.1417F, -0.0725F, -6.9846F, 0.0F, 1.0F, 7.0F, new Dilation(0.0F))
                .uv(0, 18).cuboid(-0.8583F, -0.0725F, -7.9846F, 1.0F, 0.0F, 8.0F, new Dilation(0.0F))
                .uv(16, 30).cuboid(-0.8583F, -0.0725F, 0.0154F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.087F, -0.0351F, 0.0046F));
