...
public class LarvaeAnimations {
    public static final Animation ANIM_LARVAE_CRAWL = Animation.Builder.create(0.75F).looping()
            ...
            .addBoneAnimation("cocoon", new Transformation(Transformation.Targets.TRANSLATE,
                    ...
                    new Keyframe(0.375F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.25F), Transformation.Interpolations.LINEAR),
