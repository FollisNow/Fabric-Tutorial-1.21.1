...
public class GoldPileBlock extends Block{
    ...
    public static final MapCodec<GoldPileBlock> CODEC = createCodec(GoldPileBlock::new);
    ...
    @Override
    public MapCodec<GoldPileBlock> getCodec() {
        return CODEC;
    }

    public GoldPileBlock(AbstractBlock.Settings settings) {
        super(settings);
