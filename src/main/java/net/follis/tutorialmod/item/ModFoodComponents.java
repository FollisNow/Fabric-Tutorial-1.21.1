...
public class ModFoodComponents {
    ...
    public static final FoodComponent LOCUST = new FoodComponent.Builder().nutrition(1).saturationModifier(0.15f)
            .snack().build();

    public static final FoodComponent GRILLED_LOCUST = new FoodComponent.Builder().nutrition(3).saturationModifier(0.25f)
            .snack().build();
